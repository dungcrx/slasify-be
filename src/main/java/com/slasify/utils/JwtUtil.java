...
public class JwtUtil {
    ...
    public static final long REMEMBER_ME_EXPIRATION_TIME = 30L * 24 * 60 * 60 * 1000; // 30 days

    public static final long STANDARD_EXPIRATION_TIME = 30 * 60 * 1000; // 30 minutes in milliseconds
